...
describe SearchDatabasesController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "search_databases", :action => "update", :id => '1').should == {:path => "/search_databases/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "search_databases", :action => "destroy", :id => '1').should == {:path => "/search_databases/1", :method => :delete}
    end
  end
