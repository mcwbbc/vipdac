...
describe ResultfilesController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "resultfiles", :action => "update", :id => '1').should == {:path => "/resultfiles/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "resultfiles", :action => "destroy", :id => '1').should == {:path => "/resultfiles/1", :method => :delete}
    end
  end
