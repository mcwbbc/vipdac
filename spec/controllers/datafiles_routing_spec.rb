...
describe DatafilesController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "datafiles", :action => "update", :id => "1").should == {:path => "/datafiles/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "datafiles", :action => "destroy", :id => "1").should == {:path => "/datafiles/1", :method => :delete}
    end
  end
