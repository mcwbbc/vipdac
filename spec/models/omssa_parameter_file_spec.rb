...
module OmssaParameterFileSpecHelper
  def valid_omssa_parameter_file_attributes
    {
      :name => 'test',
...
describe OmssaParameterFile do
  ...
  include OmssaParameterFileSpecHelper
  
  before(:each) do
    @omssa_parameter_file = OmssaParameterFile.new
  end
  
  it "should be valid" do
    @omssa_parameter_file.attributes = valid_omssa_parameter_file_attributes
  ...
  it do
    @omssa_parameter_file.should have(1).error_on(:name)
  end
  
  it do
    @omssa_parameter_file.should have(1).error_on(:database)
  end
  
  it do
    @omssa_parameter_file.should have(1).error_on(:enzyme)
  end
  
  it do
    @omssa_parameter_file.should have(1).error_on(:missed_cleavages)
  end
  
  it do
    @omssa_parameter_file.should have(1).error_on(:precursor_tol)
  end
  
  it do
    @omssa_parameter_file.should have(1).error_on(:product_tol)
  end
  
  it do
    @omssa_parameter_file.should have(1).error_on(:minimum_charge)
  end
  
  it do
    @omssa_parameter_file.should have(1).error_on(:max_charge)
  end
...
describe OmssaParameterFile, ".write_file" do
  
  include OmssaParameterFileSpecHelper
  
  before(:each) do
    @omssa_parameter_file = OmssaParameterFile.new valid_omssa_parameter_file_attributes
